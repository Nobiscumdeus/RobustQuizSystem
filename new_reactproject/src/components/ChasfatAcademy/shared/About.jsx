        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <button className="bg-white text-primary hover:bg-white/90 px-8 py-3 rounded-full font-bold text-lg shadow-lg transition-colors">
                Get Started Now
              </button>
            </motion.div>
          </div>
...
const AboutPage = () => {
//  const darkMode = useSelector((state) => state.ui?.displayMode || 'light');
  ...
  return (
    <AnimatePresence>
      <div className={`min-h-screen ${
        darkMode 
          ? "bg-gradient-to-br from-gray-800 via-blue-500 to-gray-300" 
        ...
        >
          <motion.button
            ...
            className={`px-4 py-2 rounded-md ${
              darkMode ? "bg-black/30 text-gray-100" : "bg-white/20 text-white"
            } backdrop-blur-sm`}
          >
            About Us
          </motion.button>
        ...
        <motion.section
          ...
          className={`px-4 py-10 ${
            darkMode ? "bg-black/20 text-gray-100" : "bg-white/10 text-white"
          }`}
        >
          <motion.h2
            variants={fadeIn}
        ...
        <motion.section
          ...
          variants={fadeInUp}
          className={`py-20 ${
            darkMode ? "bg-black/10 text-gray-100" : "bg-white/5 text-white"
          }`}
        >
          <div className="container mx-auto px-4">
            <motion.h3
