...
export const questionApi = createApi({
  ...
  tagTypes: ['Question', 'CourseQuestions'],
  endpoints: (builder) => ({
    
    // Get courses and exams for examiner
    getCoursesAndExams: builder.query({
      query: (examinerId) => ({
        url: `/courses-exams/examiner/${examinerId}`,
      }),
    }),
    ...
    createQuestion: builder.mutation({
      ...
      invalidatesTags: ['CourseQuestions'],
    }),
    ...
    updateQuestion: builder.mutation({
      ...
      invalidatesTags: ['Question', 'CourseQuestions'],
    }),
